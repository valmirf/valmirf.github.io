...
const SITE = {
  ...
  about: {
    pt: [
      ...
      "Hoje trabalho principalmente em visão computacional — e, dentro dela, em <strong>reconhecimento de texto manuscrito</strong>, que é a porta de entrada dos projetos de educação: antes de avaliar a redação ou a conta do aluno, é preciso ler o que está escrito à mão. É uma linha que sigo desde 2007, quando comecei com análise de imagem de documento, e que hoje se aplica a inteligência artificial na educação e na acessibilidade. Meus projetos costumam partir da mesma situação: um problema com consequência prática — segurança de banhistas, avaliação de matemática no ensino fundamental, comunicação de quem não fala — e poucos recursos, de máquina e de dados. Essa restrição decide o método: leva a modelos compactos, a técnicas de ajuste fino que os tornam competitivos, e a tratar custo computacional como objetivo de otimização, e não como consequência.",
    ...
    en: [
      ...
      "I work mainly on computer vision — and, within it, on <strong>handwritten text recognition</strong>, which is the entry point of the education projects: before an essay or a child's arithmetic can be assessed, what is written by hand has to be read. It is a line I have followed since 2007, when I started in document image analysis, and it now feeds into artificial intelligence for education and accessibility. My projects tend to start from the same situation: a problem with practical consequence — bather safety, elementary mathematics assessment, communication for people who do not speak — and scarce resources, in both hardware and data. That constraint decides the method: it leads to compact models, to fine-tuning techniques that make them competitive, and to treating computational cost as an optimisation objective rather than a consequence.",
  ...
  research: {
    pt: [
      ...
      "A vertente mais antiga é o <strong>reconhecimento de manuscrito</strong>. Começou em 2007, com binarização de cheque bancário e zoneamento de documento manuscrito, e é hoje o que sustenta os projetos de educação: reconhecer expressão matemática escrita por criança de escola pública, detectar a equação numa foto tirada de celular sem controle de luz nem de enquadramento, transcrever redação em papel pautado. Letra de aluno do ensino fundamental não se parece com o manuscrito adulto dos conjuntos de referência da área, e é isso que torna o problema difícil — e é onde está a maior parte do meu trabalho recente.",
      ...
      "Essa preocupação tem nome fora daqui. O <a href='https://www.un.org/independent-international-scientific-panel-ai/en/preliminary-report' target='_blank' rel='noopener'>relatório preliminar</a> do Painel Científico Internacional Independente sobre IA, das Nações Unidas, publicado em julho de 2026, organiza os efeitos da inteligência artificial em sete domínios; um deles é o das <strong>aplicações sociais</strong> — ciência, saúde, educação e agricultura. O que o relatório aponta ali não é falta de capacidade dos modelos: é benefício distribuído de forma desigual, qualidade irregular na entrega e pouca evidência sobre impacto. É onde meus projetos ficam. A parte da evidência é a que menos aparece, e é por isso que os estudos em sala de aula real e as bases de dados abertas contam aqui tanto quanto os modelos.",
    ],
    en: [
      ...
      "The oldest strand is <strong>handwriting recognition</strong>. It began in 2007 with bank-cheque binarisation and zoning of handwritten documents, and it is what the education projects now rest on: recognising mathematical expressions written by public-school children, detecting the equation in a phone photo with no control of lighting or framing, transcribing essays from ruled paper. A child's handwriting looks nothing like the adult script in the field's benchmark corpora, and that is what makes the problem hard — and where most of my recent work sits.",
      ...
      "This concern has a name beyond this page. The <a href='https://www.un.org/independent-international-scientific-panel-ai/en/preliminary-report' target='_blank' rel='noopener'>preliminary report</a> of the United Nations Independent International Scientific Panel on AI, published in July 2026, organises the effects of artificial intelligence into seven domains; one of them is <strong>societal applications</strong> — science, health, education and agriculture. What the report identifies there is not a shortfall in model capability: it is unevenly distributed benefit, uneven quality of delivery, and weak evidence on impact. That is where my projects sit. Evidence is the part that shows up least, which is why real-classroom studies and open datasets count here as much as the models do.",
    ],
  },
  ...
  projects: [
    ...
    },
    {
      ...
      contributions: {
        pt: [
          "Reconhecimento de texto manuscrito para digitalização de redações escolares em português",
          "Compreensão visual de documento com ajuste fino por LoRA, comparando modelos sob restrição de memória",
          "Restauração e verificação de pontuação com transformers explicáveis",
          "Pontuação automática por classificadores de votação e medida de coerência temática",
        ],
        en: [
          "Handwritten text recognition for digitising school essays in Portuguese",
          "Visual document understanding with LoRA fine-tuning, comparing models under memory constraints",
          "Explainable transformer-based punctuation restoration and verification",
          "Automated scoring with voting classifiers and thematic coherence measurement",
        ],
      },
      outputs: {
  ...
  topicLabels: {
    ...
    ocr:    { pt: "Reconhecimento de manuscrito", en: "Handwriting recognition" },
  ...
  publications: [
    ...
    { y: 2013, t: "Metaclasses and Zoning for Handwritten Document Recognition", doi: "10.1109/IJCNN.2013.6707056", a: "V. Macario, G. F. P. Silva, M. R. P. Souza, C. Zanchettin, G. D. C. Cavalcanti", v: "International Joint Conference on Neural Networks (IJCNN)", k: "conference", topic: "ocr" },
    ...
    { y: 2007, t: "An Efficient Thresholding Algorithm for Brazilian Bank Checks", doi: "10.1109/ICDAR.2007.4378702", a: "C. Mello, B. Bezerra, C. Zanchettin, V. Macario", v: "International Conference on Document Analysis and Recognition (ICDAR)", k: "conference", c: 5, topic: "ocr" },
